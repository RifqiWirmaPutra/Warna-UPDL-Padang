...
use App\Http\Controllers\jenisPenginapanController;
...
Route::middleware(['auth:admin'])->group(function () {
    ...
    Route::middleware([AdminMiddleware::class . ':super-admin'])->group(function () {
        ...
        //Menampilkan Jenis Penginapan
        Route::prefix('admin/jenisPenginapan')->name('admin.jenisPenginapan.')->group(function () {
            Route::get('/', [JenisPenginapanController::class, 'index'])->name('index');
            Route::get('/create', [JenisPenginapanController::class, 'create'])->name('create');
            Route::post('/store', [JenisPenginapanController::class, 'store'])->name('store');
            Route::get('/edit/{id}', [JenisPenginapanController::class, 'edit'])->name('edit');
            Route::put('/update/{id}', [JenisPenginapanController::class, 'update'])->name('update');
            Route::delete('/destroy/{id}', [JenisPenginapanController::class, 'destroy'])->name('destroy');
        });
        ...
        Route::prefix('admin')->name('admin.')->group(function () {
            Route::resource('detailHarga', DetailHargaController::class);
        });
        ...
        Route::prefix('admin')->name('admin.')->group(function () {
            ...
            Route::get('/monitoring/list', [MonitoringController::class, 'monitoringList'])->name('monitoring.list');
            Route::get('/monitoring/{id}/edit', [MonitoringController::class, 'edit'])->name('monitoring.edit');
            Route::patch('/monitoring/{id}', [MonitoringController::class, 'update'])->name('monitoring.update');
            Route::delete('/monitoring/{id}', [MonitoringController::class, 'destroy'])->name('monitoring.destroy');
            Route::patch('/monitoring/{id}/status', [MonitoringController::class, 'updateStatus'])->name('monitoring.updateStatus');
        });
        ...
        Route::post('/admin/bookings/{id}/status', [BookingPeController::class, 'updateStatus'])->name('admin.bookings.updateStatus');
        Route::get('/admin/bookings', [BookingPeController::class, 'index'])->name('admin.bookings.index');
        Route::delete('/admin/bookings/{id}', [BookingPeController::class, 'destroy'])->name('admin.bookings.destroy');
    ...
    // Route::get('/admin/bookings', [BookingPeController::class, 'index'])->name('admin.bookings.index');
    Route::post('/admin/bookings/confirm/{id}', [BookingPeController::class, 'confirm'])->name('admin.bookings.confirm');
...
// booking
Route::get('layout/booking/create/{id}', [BookingPeController::class, 'create'])->name('layouts.booking.create');

// Route untuk update harga
Route::post('/update-price', [BookingPeController::class, 'updatePrice'])->name('updatePrice');

// Menyimpan pemesanan
Route::post('layout/booking', [BookingPeController::class, 'store'])->name('layouts.booking.store');

// Halaman sukses setelah pemesanan
Route::get('booking/success/{id}', [BookingPeController::class, 'success'])->name('booking.success');



// booking2
// Route::get('/booking', [PeBookingController::class, 'booking'])->name('jdl.booking.booking'); // Menampilkan form pemesanan
// Route::post('/booking', [PeBookingController::class, 'store'])->name('booking.store'); // Menyimpan data pemesanan
// Route::get('/booking/success', [PeBookingController::class, 'success'])->name('booking.success'); // Menampilkan halaman sukses
