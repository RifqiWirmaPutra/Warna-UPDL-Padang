    ...
    <div class="hero-container">
      <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <!-- Slide 1 -->
          <div class="carousel-item active" style="background-image: url(<?php echo e(asset('landing_page/img/slide2/1.png')); ?>)">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Welcome to <img src="<?php echo e(asset('assets/images/mockup2.1.png')); ?>" alt="" class="img-fluid" style="max-width: 15rem"></h2>
          ...
          <!-- Slide 2 -->
          <div class="carousel-item" style="background-image: url(<?php echo e(asset('landing_page/img/slide2/4.png')); ?>)">
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <!-- Slide 3 -->
          <div class="carousel-item" style="background-image: url(<?php echo e(asset('landing_page/img/slide2/3.png')); ?>)">
            <div class="carousel-container">
              <div class="carousel-content">
    ...
    <section id="featured" class="featured">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
            <div class="icon-box">
            <a href="<?php echo e(route('ip.index')); ?>">
              <!-- <i class="bi bi-card-checklist"></i> -->
              <img src="<?php echo e(asset('assets/images/1.png')); ?>" alt="Icon 1" class="img-fluid mb-3" style="max-width: 60px;">
          ...
          <div class="col-lg-3 mt-4 mt-lg-0">
            <div class="icon-box">
            <a href="<?php echo e(route('jasa_layanan.index')); ?>">
              <img src="<?php echo e(asset('assets/images/3.png')); ?>" alt="Icon 2" class="img-fluid mb-3" style="max-width: 60px;">
          ...
          <div class="col-lg-3 mt-4 mt-lg-0">
            <div class="icon-box">
            <a href="<?php echo e(route('sarana.index')); ?>">
           
              <!-- <i class="bi bi-binoculars"></i> -->
              <img src="<?php echo e(asset('assets/images/4.png')); ?>" alt="Icon 3" class="img-fluid mb-3" style="max-width: 60px;">
          ...
          <div class="col-lg-3 mt-4 mt-lg-0">
            <div class="icon-box">
            <a href="<?php echo e(route('dashboardkuliner.index')); ?>">
              <!-- <i class="bi bi-binoculars"></i> -->
              <img src="<?php echo e(asset('assets/images/5.png')); ?>" alt="Icon 4" class="img-fluid mb-3" style="max-width: 60px;">
...
<?php echo $__env->make('layouts.dashboard.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Magang\vkita\Iklat\warna rizky\Warna_terbaru\Warna-Udiklat\resources\views/welcome.blade.php ENDPATH**/ ?>