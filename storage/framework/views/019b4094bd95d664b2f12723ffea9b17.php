        ...
        <?php $__currentLoopData = $penginapans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $penginapan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="room-card">
                <div class="room-image">
                    ...
                    <img id="carousel-image" src="<?php echo e(asset('storage/assets/penginapan/' . $penginapan->fotoPenginapan)); ?>"
...
<?php echo $__env->make('jdl.layouts.penginapan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Magang\vkita\Iklat\Warna-Udiklat\resources\views/jdl/penginapan/padang.blade.php ENDPATH**/ ?>