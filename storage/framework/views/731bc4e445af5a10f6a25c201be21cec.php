<?php $__env->startSection('content'); ?>
        ...
        <?php $__currentLoopData = $penginapans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $penginapan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="room-card">
                <div class="room-image">
                    ...
                    <img id="carousel-image" src="<?php echo e(asset('storage/storage/assets/penginapan/' . $penginapan->fotoPenginapan)); ?>"
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="room-price">
                                ...
                                <a href="<?php echo e(route('layouts.booking.create')); ?>">
    ...
    <script>
        // function updatePrice(priceType, price) {
        //     // Menampilkan harga yang dipilih
        //     const priceElements = document.querySelectorAll('.price');
        //     priceElements.forEach(element => {
        //         element.innerText = 'Rp ' + price.toLocaleString(); // Format harga
        //     });
        // }
        function updatePrice(priceType, price, id) {
    // Hanya memperbarui harga pada elemen dengan id yang sesuai
    const priceElement = document.getElementById('price-' + id);
    priceElement.innerText = 'Rp ' + price.toLocaleString(); // Format harga yang dipilih
}

    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('jdl.layouts.penginapan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\qi\magang\Warna-Udiklat\resources\views/jdl/penginapan/padang.blade.php ENDPATH**/ ?>