            ...
            <div class="col-md-4">
                <?php $__currentLoopData = $penginapans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $penginapan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card shadow-sm mb-4">
                        <!-- Gambar Wisma -->
                        <img src="<?php echo e(asset('storage/storage/assets/penginapan/' . $penginapan->fotoPenginapan)); ?>"
                            class="card-img-top">
                        ...
                        <div class="card-body">
                            ...
                            <?php endif; ?>
                            <h4 class="card-title font-weight-bold mb-2"><?php echo e($penginapan->tipePenginapan); ?></h4>

                            <!-- Detail Kamar -->
                            <p class="text-sm font-weight-bold mb-2">(1x) Wisma <?php echo e($penginapan->tipePenginapan); ?></p>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('layouts.booking.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-success w-100" id="submitButton" disabled>Submit
                                Booking</button>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.dashboard.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\qi\magang\Warna-Udiklat\resources\views/layouts/booking/create.blade.php ENDPATH**/ ?>