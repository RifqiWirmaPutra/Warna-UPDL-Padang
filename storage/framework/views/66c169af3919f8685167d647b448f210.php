                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody class="scrolling-content">
                            <?php if($arp->count() > 0): ?>
                                <?php $__currentLoopData = $arp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $rs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr style="transition: background-color 0.3s ease; cursor: pointer;">
                                        <td class="align-middle text-center" style="font-size: 1.2rem; font-weight: bold;"><?php echo e($key + 1); ?></td>
...
<?php echo $__env->make('layouts.dashboard.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\qi\Project Warna\1\Warna-Udiklat\resources\views/ip.blade.php ENDPATH**/ ?>