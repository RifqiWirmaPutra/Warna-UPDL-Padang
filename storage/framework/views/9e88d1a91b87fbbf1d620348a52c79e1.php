...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                     <?php $__env->slot('trigger', null, []); ?> 
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                           ...
                           <!-- <div><?php echo e(Auth::user()->name); ?> </div> ini yang asli, 2 baris dibawah tidak -->
                            <div style="background-image: url('<?php echo e(asset('landing_page/img/person.png')); ?>'); width: 25px; height: 25px; background-size: cover; margin-right: 8px;"></div>
...
<?php /**PATH F:\Magang\vkita\Iklat\warna rizky\Warna_terbaru\Warna-Udiklat\resources\views/layouts/navigation_admin.blade.php ENDPATH**/ ?>