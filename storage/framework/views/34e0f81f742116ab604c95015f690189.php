        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.penginapan.update', $penginapan->id)); ?>" method="POST"
                ...
                <div class="form-group">
                    ...
                    <input  name="fasilitas" class="form-control" value="<?php echo e($penginapan->fasilitas); ?>"
                        required>
                </div>

                <div class="form-group">
                    <label for="kapastas">Kapasitas</label>
                    <input  name="kapasitas" class="form-control" value="<?php echo e($penginapan->kapasitas); ?>"
                        required>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Magang\vkita\Iklat\warna rizky\Warna_terbaru\Warna-Udiklat\resources\views/admin/penginapan/edit.blade.php ENDPATH**/ ?>