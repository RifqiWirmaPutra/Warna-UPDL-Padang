...
<?php $__env->startSection('content'); ?>
    ...
    <style>
        #heros {
            background-image: url('<?php echo e(asset('kuliner/images/DATA_OLEH/Dashboard_POO/poleholeh.jpg')); ?>');
        ...
        <div class="container-fluid">
            <div class="row text-center">
                ...
                <div class="col-sm-4 mb-4">
                    <div class="card border-0 position-relative">
                        <div class="img-container position-relative">
                            <img src="<?php echo e(asset('kuliner/images/DATA_OLEH/DATA/christinehakim.jpg')); ?>" alt="christinehakim" class="card-img-top">
                ...
                <div class="col-sm-4 mb-4">
                    <div class="card border-0 position-relative">
                        <div class="img-container position-relative">
                            <img src="<?php echo e(asset('kuliner/images/DATA_OLEH/DATA/kripikshirley.jpg')); ?>" alt="kripikshirley" class="card-img-top">
                            <div class="overlay"></div> <!-- Efek overlay -->
                        </div>
                        <div class="card-body text-left overlay-content">
                ...
                <div class="col-sm-4 mb-4">
                    <div class="card border-0 position-relative">
                        <div class="img-container position-relative">
                            <img src="<?php echo e(asset('kuliner/images/DATA_OLEH/DATA/minangsepakat.jpg')); ?>" alt="minangsepakat" class="card-img-top">
                            <div class="overlay"></div> <!-- Efek overlay -->
                        </div>
                        <div class="card-body text-left overlay-content">
...
<?php echo $__env->make('layouts.kwt.poleh.poleh', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Downloads\part 2\Warna-Udiklat\resources\views/kwt/poleh/index.blade.php ENDPATH**/ ?>