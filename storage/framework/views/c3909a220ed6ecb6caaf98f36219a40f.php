    ...
    <div class="max-w-lg mx-auto mt-10 p-4 bg-white shadow-md rounded-lg">
        ...
        <div class="mt-6">
            ...
            <div class="bg-white p-4 mt-4 rounded-lg shadow-sm">
                ...
                <p><strong> Type Room :</strong> <?php echo e($roomType); ?></p>
                <p><strong>Total Price:</strong> Rp. <?php echo e(number_format($totalPrice, 0, ',', '.')); ?></p>
            </div>
        </div>
            ...
            <div class="bg-blue-50 p-4 mt-2 rounded-lg">
                ...
                <div class="mt-4">
                    ...
                    <div class="flex justify-between items-center mt-2">
                        ...
                        <button class="text-blue-600" onclick="copyToClipboard('<?php echo e(number_format($totalPrice, 0, ',', '.')); ?>')">
                            Copy
                        </button>
                    </div>
                    <p class="text-gray-700">Rp <?php echo e(number_format($totalPrice, 0, ',', '.')); ?></p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.dashboard.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\qi\Project Warna\1\Warna-Udiklat\resources\views/layouts/booking/success.blade.php ENDPATH**/ ?>