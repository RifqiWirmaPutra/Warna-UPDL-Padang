        ...
        <header id="header" class="d-flex align-items-center">
          <div class="container d-flex justify-content-between align-items-center">
            ...
            <nav id="navbar" class="navbar active">
              <ul class="menu">
                <li class="navbar-item <?php echo e(request()->is('/*') ? 'active' : ''); ?>"><a href="<?php echo e(route('dashboardkuliner.index')); ?>">Kembali ke Beranda</a></li>
            </ul>        
...
</html><?php /**PATH C:\Users\USER\Downloads\part 2\Warna-Udiklat\resources\views/layouts/kwt/hotel/hotel.blade.php ENDPATH**/ ?>