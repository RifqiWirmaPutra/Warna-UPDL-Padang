<?php $__env->startSection('content'); ?>
        <div id="slide">
            <div class="item" style="background-image: url('<?php echo e(asset('kuliner/images/data-wisata/air terjun lubuk bonta/m.png')); ?>');">
                <div class="content">
                    ...
                    <a href="<?php echo e(route('lubuk-bonta')); ?>">
            ...
            <div class="item" style="background-image: url('<?php echo e(asset('kuliner/images/data-wisata/danau maninjau/m.jpg')); ?>');">
                <div class="content">
                    ...
                    <a href="<?php echo e(route('maninjau')); ?>">
            ...
            <div class="item" style="background-image: url('<?php echo e(asset('kuliner/images/data-wisata/danau singkarak/m.jpg')); ?>');">
                <div class="content">
                    ...
                    <a href="<?php echo e(route('singkarak')); ?>">
            ...
            <div class="item" style="background-image: url('<?php echo e(asset('kuliner/images/data-wisata/Istano Basa Pagaruyung/m.jpg')); ?>');">
                <div class="content">
                    ...
                    <a href="<?php echo e(route('pagaruyuang')); ?>">
            ...
            <div class="item" style="background-image: url('<?php echo e(asset('kuliner/images/data-wisata/jam gadang/m.jpeg')); ?>');">
                <div class="content">
                    ...
                    <a href="<?php echo e(route('jamgadang')); ?>">
            ...
            <div class="item" style="background-image: url('<?php echo e(asset('kuliner/images/data-wisata/kolam tirta alami/m.jpg')); ?>');">
                <div class="content">
                    ...
                    <a href="<?php echo e(route('tirtaAlami')); ?>">
            ...
            <div class="item" style="background-image: url('<?php echo e(asset('kuliner/images/data-wisata/LEMBAH ANAI/m.jpg')); ?>');">
                <div class="content">
                    ...
                    <div class="des"><i class="fas fa-map-marker-alt"></i> Kec. 2 X 11 Kayu Tanam, Kabupaten Padang Pariaman</div>
                    <a href="<?php echo e(route('lembahAnai')); ?>">
            ...
            <div class="item" style="background-image: url('<?php echo e(asset('kuliner/images/data-wisata/masjid raya sumbar/m.jpg')); ?>');">
                <div class="content">
                    ...
                    <div class="des"><i class="fas fa-map-marker-alt"></i> Kec. 2 X 11 Kayu Tanam, Kabupaten Padang Pariaman</div>
                    <a href="<?php echo e(route('mesjidRaya')); ?>">
            ...
            <div class="item" style="background-image: url('<?php echo e(asset('kuliner/images/data-wisata/pantai air manis/m.jpg')); ?>');">
                <div class="content">
                    <div class="name">Pantai Air Manis</div>
                    <div class="des">Menikmati Kelembutan Pasir dan Kesejukan Ombak</div>
                    <div class="des"><i class="fas fa-map-marker-alt"></i> Kec. 2 X 11 Kayu Tanam, Kabupaten Padang Pariaman</div>
                    <a href="<?php echo e(route('airManis')); ?>">
            ...
            <div class="item" style="background-image: url('<?php echo e(asset('kuliner/images/data-wisata/pantai gundoriah/m.jpg')); ?>');">
                <div class="content">
                    ...
                    <div class="des"><i class="fas fa-map-marker-alt"></i> Kec. 2 X 11 Kayu Tanam, Kabupaten Padang Pariaman</div>
                    <a href="<?php echo e(route('gondariah')); ?>">                    
            ...
            <div class="item" style="background-image: url('<?php echo e(asset('kuliner/images/data-wisata/pantai pasir jambak/m.jpeg')); ?>');">
                <div class="content">
                    ...
                    <div class="des"><i class="fas fa-map-marker-alt"></i> Kec. 2 X 11 Kayu Tanam, Kabupaten Padang Pariaman</div>
                    <a href="<?php echo e(route('pasirJambak')); ?>">
            ...
            <div class="item" style="background-image: url('<?php echo e(asset('kuliner/images/data-wisata/puncak lawang/m.jpg')); ?>');">
                <div class="content">
                    <div class="name">Puncak Lawang</div>
                    <div class="des">Menyaksikan Keelokan Alam dari Ketinggian</div>
                    <div class="des"><i class="fas fa-map-marker-alt"></i> Kec. 2 X 11 Kayu Tanam, Kabupaten Padang Pariaman</div>
                    <a href="<?php echo e(route('lawang')); ?>">
            ...
            <div class="item" style="background-image: url('<?php echo e(asset('kuliner/images/data-wisata/Taman Wisata Lembah Harau/m.jpg')); ?>');">
                <div class="content">
...
<?php echo $__env->make('layouts.kwt.wisata.wisata', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Downloads\part 2\Warna-Udiklat\resources\views/kwt/wisata/index.blade.php ENDPATH**/ ?>