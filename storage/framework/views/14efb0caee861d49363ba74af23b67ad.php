...
<div class="banner">
        ...
        <div class="container-fluid"> 
            <div class="row text-center">
                <div class="col-sm-3 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/zhmpremire (2).jpg')); ?>" alt="zhmpremire" class="img-fluid">
                ...
                <div class="col-sm-3 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/mercure (4).jpg')); ?>" alt="mercure" class="img-fluid">
                ...
                <div class="col-sm-3 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/rockyplaza (2).jpg')); ?>" alt="rockyplaza" class="img-fluid">
                ...
                <div class="col-sm-3 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/pangeran (4).jpg')); ?>" alt="pangeran" class="img-fluid">
            ...
            <div class="row text-center">
                <div class="col-sm-3 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/basko (2).jpg')); ?>" alt="basko" class="img-fluid">
                ...
                <div class="col-sm-3 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/axana.jpg')); ?>" alt="axana" class="img-fluid">
                ...
                <div class="col-sm-3 mb-4">
                  <div class="card">
                      <div class="card-body">
                          <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/daimahotel.jpg')); ?>" alt="daimahotel" class="img-fluid">
                ...
                <div class="col-sm-3 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/unphotel.jpg')); ?>" alt="unphotel" class="img-fluid">
                ...
                <div class="col-sm-3 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/ibisthotel (4).jpg')); ?>" alt="ibis" class="img-fluid">
                ...
                <div class="col-sm-3 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/grandsari.jpg')); ?>" alt="grandsari" class="img-fluid">
                ...
                <div class="col-sm-3 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/favehotel.jpg')); ?>" alt="favehotel" class="img-fluid">
                ...
                <div class="col-sm-3 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/kawana.jpg')); ?>" alt="kawana" class="img-fluid">
                ...
                <div class="col-sm-3 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/whizprime.jpg')); ?>" alt="iiwhizprimebumi" class="img-fluid">
                ...
                <div class="col-sm-3 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/kyriadhotel (4).jpg')); ?>" alt="kyriadhotel" class="img-fluid">
    ...
    <div class="hotel">
        <div class="container">
            <div class="slide-hotel" style="background-image: url('<?php echo e(asset('kuliner/images/DATA_HOTEL/ibisthotel (4).jpg')); ?>')">
                <h3>IBIS HOTEL</h3>
            </div>

            <div class="slide-hotel" style="background-image: url('<?php echo e(asset('kuliner/images/DATA_HOTEL/kawana (2).jpg')); ?>')">
                <h3>KAWANA HOTEL</h3>
            </div>

            <div class="slide-hotel active-hotel" style="background-image: url('<?php echo e(asset('kuliner/images/DATA_HOTEL/basko (2).jpg')); ?>')">
                <h3>BASKO HOTEL</h3>
            </div>

            <div class="slide-hotel" style="background-image: url('<?php echo e(asset('kuliner/images/DATA_HOTEL/mercure (4).jpg')); ?>')">
                <h3>MERCURE HOTEL</h3>
            </div>

            <div class="slide-hotel" style="background-image: url('<?php echo e(asset('kuliner/images/DATA_HOTEL/pangeran (3).jpg')); ?>')">
                <h3>PANGERAN HOTEL</h3>
            </div>

            <div class="slide-hotel" style="background-image: url('<?php echo e(asset('kuliner/images/DATA_HOTEL/daimahotel (4).jpg')); ?>')">
                <h3>DAIMA HOTEL</h3>
            </div>

            <div class="slide-hotel" style="background-image: url('<?php echo e(asset('kuliner/images/DATA_HOTEL/santikahotel.jpg')); ?>')">
                <h3>SANTIKA HOTEL</h3>
            </div>

            <div class="slide-hotel" style="background-image: url('<?php echo e(asset('kuliner/images/DATA_HOTEL/unphotel (3).jpg')); ?>')">
                <h3>UNP HOTEL</h3>
            </div>

            <div class="slide-hotel" style="background-image: url('<?php echo e(asset('kuliner/images/DATA_HOTEL/axana (3).jpg')); ?>')">
                <h3>AXANA HOTEL</h3>
            </div>

            <div class="slide-hotel" style="background-image: url('<?php echo e(asset('kuliner/images/DATA_HOTEL/grandsari (2).jpg')); ?>')">
                <h3>GRAND SARI HOTEL</h3>
            </div>

            <div class="slide-hotel" style="background-image: url('<?php echo e(asset('kuliner/images/DATA_HOTEL/santikahotel (3).jpg')); ?>')">
                <h3>SANTIKA HOTEL</h3>
            </div>

            <div class="slide-hotel" style="background-image: url('<?php echo e(asset('kuliner/images/DATA_HOTEL/kriyadhotel.jpg')); ?>')">
                <h3>KRIYAD HOTEL</h3>
            </div>

            <div class="slide-hotel" style="background-image: url('<?php echo e(asset('kuliner/images/DATA_HOTEL/kawana (4).jpg')); ?>')">
                <h3>Kawana HOTEL</h3>
            </div>
        </div>
    </div>
                        ...
                        <div id="carouselzhmpremire" class="carousel slide mb-4" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/zhmpremire.jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 1">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/zhmpremire (2).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 2">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/zhmpremire (3).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/zhmpremire (4).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div id="carouselmercure" class="carousel slide mb-4" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/mercure.jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 1">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/mercure (2).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 2">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/mercure (3).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/mercure (4).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div id="carouselrockyplaza" class="carousel slide mb-4" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/rockyplaza.jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 1">
                                </div><div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/rockyplaza (2).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 2">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/rockyplaza (3).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/rockyplaza (4).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div id="carouselpangeran" class="carousel slide mb-4" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/pangeran.jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 1">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/pangeran (2).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 2">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/pangeran (3).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/pangeran (4).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div id="carouselbasko" class="carousel slide mb-4" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/basko.jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 1">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/basko (2).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 2">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/basko (3).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/basko (4).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div id="carouselaxana" class="carousel slide mb-4" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/axana.jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 1">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/axana (2).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 2">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/axana (3).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/axana (4).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div id="carouseldaimahotel" class="carousel slide mb-4" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/daimahotel.jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 1">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/daimahotel (2).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 2">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/daimahotel (3).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/daimahotel (4).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div id="carouselunphotel" class="carousel slide mb-4" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/unphotel.jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 1">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/unphotel (2).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 2">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/unphotel (3).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/unphotel (4).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div id="carouselibisthotel" class="carousel slide mb-4" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/ibisthotel.jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 1">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/ibisthotel (2).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 2">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/ibisthotel (3).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/ibisthotel (4).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div id="carouselgrandsari" class="carousel slide mb-4" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/grandsari.jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 1">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/grandsari (2).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 2">
                                </div>
                                <div class="carousel-item"><img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/grandsari (3).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/grandsari (4).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div id="carouselfavehotel" class="carousel slide mb-4" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/favehotel.jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 1">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/favehotel (2).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 2">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/favehotel (3).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/favehotel (4).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div id="carouselkawana" class="carousel slide mb-4" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/kawana.jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 1">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/kawana (2).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 2">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/kawana (3).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/kawana (4).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div id="carouselwhizprime" class="carousel slide mb-4" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/whizprime.jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 1">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/whizprime (2).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 2">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/whizprime (3).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/whizprime (4).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div id="carouselkyriadhotel" class="carousel slide mb-4" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/kyriadhotel.jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 1">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/kyriadhotel (2).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 2">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/kyriadhotel (3).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(asset('kuliner/images/DATA_HOTEL/kyriadhotel (4).jpg')); ?>" class="d-block w-100" alt="Lamun Ombak 3">
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.kwt.hotel.hotel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\Downloads\part 2\Warna-Udiklat\resources\views/kwt/hotel/index.blade.php ENDPATH**/ ?>