...
<head>
    ...
    <link href="<?php echo e(asset('landing_page/img/paneladmin.png')); ?>" rel="icon">
    ...
    <div id="app">
            ...
            <div class="sidebar-wrapper active">
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="logo">
                            <a href="<?php echo e(route('admin.dashboard')); ?>"><img
                                    src="<?php echo e(asset('assets/images/mockup2.1.png')); ?>" alt="Logo Warna" srcset=""
                                    style="min-width: 8rem; min-height: 5rem;"></a>
                        </div>
                        <div class="toggler">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item">
                            <a href="<?php echo e(route('admin.aip.view')); ?>" class='sidebar-link'>
                        ...
                        <li class="sidebar-item has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item">
                                    <a href="<?php echo e(route('arp.index')); ?>">Rendiklat</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="<?php echo e(route('Adh.index')); ?>">Daftar Hadir Peserta</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="<?php echo e(route('penginapan.index')); ?>">Informasi Penginapan (COMING SOON)</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item">
                            <a href="<?php echo e(route('index.arsip')); ?>" class='sidebar-link'>
                        ...
                        ?>
                        <?php if($userRole === Admin::ROLE_SUPERADMIN): ?>
                            <li class="sidebar-item has-sub">
                                <a href="#" class='sidebar-link'>
                                ...
                                <ul class="submenu ">
                                    <li class="submenu-item ">
                                        <a href="<?php echo e(route('contactadmin.index')); ?>">Contact</a>
                                    </li>

                                    <li class="submenu-item">
                                        <a href="<?php echo e(route('kelas.index')); ?>">Kelas</a>
                                    </li>

                                    <li class="submenu-item ">
                                        <a href="<?php echo e(route('wisma.index')); ?>">Wisma</a>
                                    </li>

                                    <li class="submenu-item ">
                                        <a href="<?php echo e(route('sarana.admin')); ?>">Sarana & Prasarana</a>
                                    </li>

                                    <li class="submenu-item ">
                                        <a href="<?php echo e(route('informasiadmin.admin')); ?>">Informasi</a>
                                    </li>
                                </ul>
                            </li>
                        <?php endif; ?>
                        <li class="sidebar-item">
                            <a href="<?php echo e(route('feedbackadmin.index')); ?>" class='sidebar-link'>
                        ...
                        <?php if(in_array($userRole, [Admin::ROLE_SUPERADMIN, Admin::ROLE_AdminJar])): ?>
                            <li class="sidebar-item">
                                <a href="<?php echo e(route('adh.pengajuan')); ?>" class='sidebar-link'>
                        ...
                        <?php if($userRole === Admin::ROLE_SUPERADMIN): ?>
                            <li class="sidebar-item has-sub">
                                ...
                                <ul class="submenu ">
                                    ...
                                    <li class="submenu-item">
                                        <a href="<?php echo e(route('admin.penginapan.index')); ?>">Informasi Penginapan</a>

                                    </li>
                                    <li class="submenu-item ">
                                        <a href="<?php echo e(route('admin.ruangan.index')); ?>">Ruangan</a>
                                    </li>

                                    <li class="submenu-item">
                                        <a href="<?php echo e(route('admin.peralatan.index')); ?>">Peralatan</a>
                                    </li>

                                    <li class="submenu-item ">
                                        <a href="<?php echo e(route('wisma.index')); ?>">Pembelajaran</a>
                                    </li>
                        ...
                        <?php if($userRole === Admin::ROLE_SUPERADMIN): ?>
                            <li class="sidebar-item has-sub">
                                ...
                                <ul class="submenu ">
                                    ...
                                    <li class="submenu-item ">
                                        <a href="<?php echo e(route('admin.monitoring.index')); ?>">Monitoring</a>
                                    </li>
                                </ul>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if(in_array($userRole, [Admin::ROLE_SUPERADMIN, Admin::ROLE_AdminJar])): ?>
                            <li class="sidebar-item">
                                <a href="<?php echo e(route('settings.absensi')); ?>" class='sidebar-link'>
                        ...
                        <?php if($userRole === Admin::ROLE_SUPERADMIN): ?>
                            <li class="sidebar-item">
                                ...
                                <a href="<?php echo e(route('accounts.create')); ?>" class='sidebar-link'>
                                    <i class="bi bi-person-plus-fill"></i>
        ...
        <div id="main">
            <header class="mb-0">
                ...
                <?php echo $__env->make('layouts.navigation_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH F:\Magang\vkita\Iklat\warna rizky\Warna_terbaru\Warna-Udiklat\resources\views/layouts/admin.blade.php ENDPATH**/ ?>