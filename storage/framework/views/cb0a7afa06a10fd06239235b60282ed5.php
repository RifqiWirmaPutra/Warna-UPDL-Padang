                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="<?php echo e(route('admin.bookings.destroy', $booking->id)); ?>" method="POST" style="display:inline;">
                                                ...
                                                <button type="submit" class="btn btn-sm btn-outline-danger" title="Hapus Booking">
                                                    <i class="bi bi-trash"></i> Hapus
                                                </button>
                                            </form>
                                        </td>
                                        <td>
                                            <select class="form-select form-select-sm" onchange="updateStatus(this, <?php echo e($booking->id); ?>)">
                                                <option value="0" <?php echo e($booking->status == 0 ? 'selected' : ''); ?>>Pending</option>
                                                <option value="1" <?php echo e($booking->status == 1 ? 'selected' : ''); ?>>Confirmed</option>
                                                <option value="2" <?php echo e($booking->status == 2 ? 'selected' : ''); ?>>Cancel</option>
                                            </select>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\qi\magang\Warna-Udiklat\resources\views/admin/bookings/index.blade.php ENDPATH**/ ?>