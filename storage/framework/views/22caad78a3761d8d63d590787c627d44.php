            ...
            <nav id="navbar" class="navbar active">
                <ul class="menu">
                    <li class="navbar-item <?php echo e(request()->is('/*') ? 'active' : ''); ?>"><a
                            href="<?php echo e(route('penginapan.index')); ?>">Kembali ke Halaman Sebelumnya</a></li>
...
<?php /**PATH F:\Magang\vkita\Iklat\warna rizky\Warna_terbaru\Warna-Udiklat\resources\views/jdl/layouts/penginapan.blade.php ENDPATH**/ ?>