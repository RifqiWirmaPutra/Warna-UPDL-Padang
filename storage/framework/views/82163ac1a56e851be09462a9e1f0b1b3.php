<?php $__env->startSection('content'); ?>
            ...
            <div class="col-md-4">
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-sm font-weight-bold mb-2"><strong>Fasilitas:</strong> <?php echo e($penginapans->fasilitas); ?>

                        </p>
                        <p class="text-sm font-weight-bold mb-2"><strong>Kapasitas:</strong> <?php echo e($penginapans->kapasitas); ?>
                        ...
                        <form action="<?php echo e(route('layouts.booking.store')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                <label class="inline-flex items-center">
                                    <input type="checkbox" id="kebijakanCheckbox" class="form-checkbox" disabled />
                                    <span class="ml-2 text-sm">
                                        Saya setuju dengan
                                        <a href="javascript:void(0)" class="text-blue-600"
                                            onclick="openModal('kebijakanModal', 'kebijakanCheckbox')">Kebijakan
                                            Privasi</a>
                                    </span>
                                </label>
                            </div>
                            ...
                            <div class="mb-4">
                                <label class="inline-flex items-center">
                                    <input type="checkbox" id="syaratCheckbox" class="form-checkbox" disabled />
                                    <span class="ml-2 text-sm">
                                        Saya setuju dengan
                                        <a href="javascript:void(0)" class="text-blue-600"
                                            onclick="openModal('syaratModal', 'syaratCheckbox')">Syarat dan Ketentuan</a>
                                    </span>
                                </label>
                            </div>
    ...
    <script>
        //Harga
        // document.getElementById('tanggalMasuk').addEventListener('change', calculateTotalPrice);
        // document.getElementById('tanggalKeluar').addEventListener('change', calculateTotalPrice);

        // function calculateTotalPrice() {
        //     const checkInDate = new Date(document.getElementById('tanggalMasuk').value);
        //     const checkOutDate = new Date(document.getElementById('tanggalKeluar').value);

        //     if (checkInDate && checkOutDate && checkOutDate > checkInDate) {
        //         const diffTime = Math.abs(checkOutDate - checkInDate);
        //         const diffDays = Math.ceil(diffTime / (1000 * 60 * 60 * 24)); // Konversi ms ke hari

        //         document.getElementById('jumlahHari').value = diffDays;

        //         // Ambil harga dari backend (misalnya `hargaPerHari`)
        //         const hargaPerHari = <?php echo e($penginapans->hargaPerHari ?? 0); ?>;
        //         const totalPrice = diffDays * hargaPerHari;

        //         document.getElementById('totalHarga').value = `Rp ${new Intl.NumberFormat().format(totalPrice)}`;
        //     } else {
...
<?php echo $__env->make('jdl.layouts.booking', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Magang\vkita\Iklat\warna rizky\Warna_terbaru\Warna-Udiklat\resources\views/layouts/booking/create.blade.php ENDPATH**/ ?>