            ...
            <nav id="navbar" class="navbar active">
                <ul class="menu">
                    <li class="navbar-item <?php echo e(request()->is('/*') ? 'active' : ''); ?>"><a
                            href="<?php echo e(route('penginapan.padang')); ?>">Kembali ke Halaman Sebelumnya</a></li>
...
<?php echo $__env->make('layouts.dashboard.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Magang\vkita\Iklat\warna rizky\Warna_terbaru\Warna-Udiklat\resources\views/jdl/layouts/booking.blade.php ENDPATH**/ ?>