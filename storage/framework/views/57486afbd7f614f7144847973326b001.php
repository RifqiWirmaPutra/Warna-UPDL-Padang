                        ...
                        <table class="table table-bordered table-striped mb-0" id="table1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle"><?php echo e($contact->nama_visit); ?></td>
                                    <td class="align-middle"><?php echo e($contact->email_visit); ?></td>
                                    <td class="align-middle"><?php echo e($contact->subject); ?></td>
                                    <td class="align-middle"><?php echo e($contact->pesan); ?></td>
                                    <td class="align-middle" id="status-<?php echo e($contact->id); ?>" data-status="<?php echo e($contact->status); ?>" style="cursor: pointer;" onclick="markAsRead(<?php echo e($contact->id); ?>)">
                                        <span class="badge <?php echo e($contact->status == 1 ? 'bg-success' : 'bg-danger'); ?> text-white">
                                            <?php echo e($contact->status == 1 ? 'Sudah Dibaca' : 'Belum Dibaca'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\qi\Project Warna\1\Warna-Udiklat\resources\views/admin/contact/index.blade.php ENDPATH**/ ?>