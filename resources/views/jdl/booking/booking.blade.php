...
@section('content')
    ...
    <head>
        ...
        <title>Pemesanan Akomodasi</title>
    ...
    <body class="bg-gray-50">
        <div class="max-w-5xl mx-auto p-4">
            ...
            <p class="text-gray-600 mb-6">Pastikan anda mengisi semua informasi pada halaman ini untuk melanjutkan transaksi
            </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-white p-4 rounded-lg shadow-md">
                        <img alt="Room Image" class="w-full rounded-lg mb-4" height="200"
                            ...
                            width="300" />
                        <h2 class="text-lg font-bold mb-2">Wisma UP 7</h2>
                        <p class="text-gray-600 mb-4">Family Room</p>

                        <div class="flex flex-col md:flex-row gap-4 mb-6">
                            <div class="flex flex-col items-center w-full md:w-1/2 px-2">
                                <p class="text-sm text-gray-500 mb-1 text-center">Check in</p>
                                <input class="w-full p-2 border border-gray-300 rounded-lg date-input" type="date"
                                    id="check-in-date" />
                            </div>
                            <div class="flex flex-col items-center w-full md:w-1/2 px-2">
                                <p class="text-sm text-gray-500 mb-1 text-center">Check out</p>
                                <input class="w-full p-2 border border-gray-300 rounded-lg date-input" type="date"
                                    id="check-out-date" />
                            </div>
                        </div>

                        <p class="text-sm font-semibold mb-2">(1x) Wisma UP 7.2 Twin Bed</p>
                        <div class="flex items-center mb-2">
                            <i class="fas fa-user-friends text-gray-500 mr-2"></i>
                            <p class="text-sm">2 Tamu</p>
                        </div>
                        <div class="flex items-center mb-2">
                            <i class="fas fa-bed text-gray-500 mr-2"></i>
                            <p class="text-sm">2 Single Bed</p>
                        </div>
                        <div class="flex items-center mb-2">
                        ...
                        <div class="flex justify-between items-center mt-4">
                            <p class="text-sm font-semibold">Total Harga kamar</p>
                            <p class="text-sm font-semibold">Rp 350.000</p>
                        </div>
                    </div>
                    <div class="col-span-2">
                        <div class="bg-white p-6 rounded-lg shadow-md mb-6">
                            <h2 class="text-lg font-bold mb-4">Data Pemesanan</h2>
                            <p class="text-sm text-gray-600 mb-4">Isi semua kolom dengan benar untuk memastikan kamu dapat
                                menerima voucher konfirmasi pemesanan di email yang dicantumkan.</p>
                            <form>
                                <div class="mb-4">
                                    <label class="block text-sm font-semibold mb-2" for="nama">Nama Lengkap</label>
                                ...
                                <div class="mb-4">
                                    <label class="block text-sm font-semibold mb-2" for="no_hp">No HP</label>
                                    <div class="flex">
                                        <select class="p-2 border border-gray-300 rounded-l-lg" id="country_code">
                                            ...
                                            <option value="242">Réunion (+262)</option>
                                            ...
                                            <option value="1-284">Virgin Islands (+1-284)</option>
                                        ...
                                        <input class="w-full p-2 border border-gray-300 rounded-r-lg" id="no_hp"
                                            placeholder="No. HP" type="text" />
                                    </div>
                                </div>
                                <div class="mb-4">
                                    <label class="block text-sm font-semibold mb-2" for="nik">NIK</label>
                                    <input class="w-full p-2 border border-gray-300 rounded-lg" id="nik"
                                        placeholder="Nomor Induk Kependudukan" type="text" />
                                </div>
                                <div class="mb-4">
                                    <label class="block text-sm font-semibold mb-2" for="nik">NIP</label>
                                    <input class="w-full p-2 border border-gray-300 rounded-lg" id="nik"
                                        placeholder="Nomor Induk Pegawai" type="text" />
                                </div>
                                <div class="mb-4">
                                    <label class="block text-sm font-semibold mb-2" for="special_requests">Permintaan
                                        Khusus</label>
                                    <textarea class="w-full p-2 border border-gray-300 rounded-lg" id="special_requests" rows="3"
                                        placeholder="Masukkan permintaan khusus jika ada"></textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" class="form-checkbox" required />
                                        <span class="ml-2 text-sm">Saya setuju dengan <a href="#"
                                                class="text-blue-600">Kebijakan Privasi</a></span>
                                    </label>
                                </div>
                                <div class="mb-4">
                                    <label class="inline-flex items-center">
                                ...
                                <button class="w-full bg-blue-600 text-white p-2 rounded-lg" type="submit">Kirim</button>
                            </form>
                        </div>
                    </div>
                </div>
