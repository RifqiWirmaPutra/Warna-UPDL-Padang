            ...
            <div class="room-card">
                <div class="room-image">
                    ...
                    <img id="carousel-image"
                        src="{{ asset('storage/storage/assets/penginapan/' . $penginapan->fotoPenginapan) }}"
                        alt="{{ $penginapan->tipePenginapan }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-group">
                                    <div class="button"
                                        onclick="updatePrice('hargadpln', {{ $penginapan->hargadpln }}, {{ $penginapan->id }})">
                                        Daily PLN Group</div>
                                    <div class="button"
                                        onclick="updatePrice('hargampln', {{ $penginapan->hargampln }}, {{ $penginapan->id }})">
                                        Monthly PLN Group</div>
                                </div>
                                <div class="button-group">
                                    <div class="button"
                                        onclick="updatePrice('hargadnonpln', {{ $penginapan->hargadnonpln }}, {{ $penginapan->id }})">
                                        Daily Non PLN Group</div>
                                    <div class="button"
                                        onclick="updatePrice('hargamnonpln', {{ $penginapan->hargamnonpln }}, {{ $penginapan->id }})">
                                        Monthly Non PLN Group</div>
                                </div>

                            </td>
                            <td class="room-price">
                                <div class="price" id="price-{{ $penginapan->id }}">Rp 0</div>
                                <a href="{{ route('layouts.booking.create', ['id' => $penginapan->id]) }}">
                                    @php
                                        session(['price' => 0]); // Menginisialisasi harga session
                                    @endphp
                                    <div id="button-container-booking" class="button-container">
                                        <button id="booking-button-{{ $penginapan->id }}" class="price-button"
