  ...
  <div class="max-w-5xl mx-auto p-4">
   <div class="flex justify-between items-center mb-6">
    <div class="flex items-center">
     <img alt="Logo" class="mr-2" height="40" src="https://oaidalleapiprodscus.blob.core.windows.net/private/org-LmQ09WWGIGwOeeA4ArnRw0x5/user-uJPET5fjNenSso8wCETWVNOp/img-JOZuDN86QMoOWVWSuM3cFjL2.png?st=2024-09-18T00%3A51%3A16Z&amp;se=2024-09-18T02%3A51%3A16Z&amp;sp=r&amp;sv=2024-08-04&amp;sr=b&amp;rscd=inline&amp;rsct=image/png&amp;skoid=d505667d-d6c1-4a0a-bac7-5c84a87759f8&amp;sktid=a48cca56-e6da-484e-a814-9c849652bcb3&amp;skt=2024-09-17T23%3A30%3A30Z&amp;ske=2024-09-18T23%3A30%3A30Z&amp;sks=b&amp;skv=2024-08-04&amp;sig=xWtcvGrgUE7dotD508fMIqTLlqrfxnnrM2W05dAdtOk%3D" width="40"/>
     ...
     <div class="bg-white p-6 rounded-lg shadow-md mb-6">
      ...
      <form>
       <div class="mb-4">
        ...
        <input class="w-full p-2 border border-gray-300 rounded-lg" id="nama" placeholder="Isi nama pemesan sesuai dengan KTP/Paspor/SIM (Tanpa tanda baca/gelar)" type="text"/>
       </div>
       <div class="mb-4">
        <label class="block text-sm font-semibold mb-2" for="email">
         Email
        </label>
        <input class="w-full p-2 border border-gray-300 rounded-lg" id="email" placeholder="Email yang akan menerima E-Voucher" type="email"/>
       </div>
       <div class="mb-4">
        ...
        <div class="flex">
         ...
         <input class="w-full p-2 border border-gray-300 rounded-r-lg" id="no_hp" placeholder="+628123456789, untuk Kode Negara (+62) dan No. Handphone 081234567" type="text"/>
        </div>
       </div>
       <div class="mb-4">
        ...
        <input class="w-full p-2 border border-gray-300 rounded-lg" id="nik" placeholder="Masukkan NIK sesuai dengan di KTP" type="text"/>
       </div>
      </form>
     </div>
     <div class="bg-white p-6 rounded-lg shadow-md mb-6">
      ...
      <p class="text-sm text-gray-600">
       Ketersediaan permintaanmu akan dikonfirmasikan pada waktu check-in. Biaya tambahan mungkin akan dikenakan tapi kamu masih bisa membatalkannya nanti.
      </p>
     </div>
