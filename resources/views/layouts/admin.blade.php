                    ...
                    <div class="d-flex justify-content-between">
                        <div class="logo">
                            <a href="{{ route('admin.dashboard') }}"><img
                                    src="{{ asset('assets/images/mockup2.1.png') }}" alt="Logo Warna" srcset=""
                    ...
                    <ul class="menu">
                        ...
                        @if ($userRole === Admin::ROLE_SUPERADMIN)
                            <li class="sidebar-item has-sub">
                                ...
                                <ul class="submenu ">
                                    ...
                                    {{-- <li class="submenu-item">
                                        <a href="{{ route('admin.detailHarga.index') }}">Detail Harga</a>
                                    </li> --}}
                                </ul>
                            </li>
                        @endif
                        @if ($userRole === Admin::ROLE_SUPERADMIN)
                            <li class="sidebar-item has-sub">
                                ...
                                <ul class="submenu ">
                                    <li class="submenu-item ">
                                        <a href="{{ route('admin.jenisPenginapan.index') }}">Jenis Penginapan</a>
                                    </li>
                                    <li class="submenu-item ">
