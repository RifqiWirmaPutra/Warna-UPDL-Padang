        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-4">
                ...
                <div class="card shadow-sm mb-4">
                    <!-- Gambar Wisma -->
                    <img src="{{ asset('storage/storage/assets/penginapan/' . $penginapans->fotoPenginapan) }}"
                        class="card-img-top">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <h4 class="card-title font-weight-bold mb-2">{{ $penginapans->tipePenginapan }}</h4>

                        <!-- Detail Kamar -->
                        <p class="text-sm font-weight-bold mb-2">(1x) Wisma {{ $penginapans->tipePenginapan }}</p>
                        <ul class="list-unstyled mb-3">
                            @foreach ($fasilitas as $fasilitasItem)
                                <li class="d-flex align-items-center mb-2">
                                    <i class="fas fa-check text-secondary mr-2"></i>
                                    <span>{{ trim($fasilitasItem) }}</span> <!-- Menghapus spasi tambahan -->
                                </li>
                            @endforeach
                        </ul>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            @if (session('price'))
                                <p>Total Harga: Rp {{ number_format(session('price')) }}</p>
                            @else
            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    ...
                    <form action="{{ route('layouts.booking.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <input type="hidden" name="tipeKamar" value="{{ $penginapans->id }}">
                        <input type="hidden" name="pilihanKamar"
                            value="{{ session('price') == $penginapans->hargadpln
                                ? 'Daily PLN Group'
                                : (session('price') == $penginapans->hargampln
                                    ...
                                    : (session('price') == $penginapans->hargadnonpln
                                        ...
                                        : (session('price') == $penginapans->hargamnonpln
                                            ...
                                            : ''))) }}">
                        <input type="hidden" name="harga" value="{{ session('price') ?? 0 }}">
                                ...
                                <label class="inline-flex items-center">
                                    ...
                                    <span class="ml-2 text-sm">
                                        ...
                                        <a href="javascript:void(0)" class="text-blue-600"
                                            onclick="openModal('kebijakanModal')">Kebijakan Privasi</a>
                                    </span>
                                </label>
                            </div> --}}
                            ...
                            {{-- <div class="mb-4">
                                <label class="inline-flex items-center">
                                    ...
                                    <span class="ml-2 text-sm">
                                        Saya setuju dengan
                                        <a href="javascript:void(0)" class="text-blue-600"
                                            onclick="openModal('syaratModal')">Syarat dan Ketentuan</a>
                                    </span>
                                </label>
                            </div> --}}
